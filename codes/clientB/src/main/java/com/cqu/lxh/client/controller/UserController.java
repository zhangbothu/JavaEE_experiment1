...
public class UserController {
    ...
    @GetMapping("/binfo")
    public ModelAndView binfo(HttpSession session) {
        ...
        return new ModelAndView("B_info.html", model);
    }

    @GetMapping("/ainfo")
    public ModelAndView ainfo() {
        return new ModelAndView("redirect:"+SSOClientService.CLIENTA_HOST_URL+"/ainfo");
    }
}